...
class LCMAgent():
    def __init__(self, cfg, se, command_profile):
        ...
        if "footswing_height_cmd" in self.obs_scales.keys():
            ...
            self.commands_scale = np.array(
                [self.obs_scales["lin_vel"], self.obs_scales["lin_vel"],
                 ...
                 self.obs_scales["body_roll_cmd"], self.obs_scales["aux_reward_cmd"],
                 self.obs_scales["compliance_cmd"], self.obs_scales["stance_width_cmd"]
                 ])[:self.num_commands]
        else:
            self.commands_scale = np.array(
                [self.obs_scales["lin_vel"], self.obs_scales["lin_vel"],
