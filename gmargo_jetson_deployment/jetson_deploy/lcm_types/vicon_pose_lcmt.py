...
class vicon_pose_lcmt(object):
    __slots__ = ["translation", "rotation", "euler", "linear_velocity", "angular_velocity", "seq", "stamp_secs",
                 "stamp_nsecs", "timestamp_us"]
    ...
    def get_hash(self):
        ...
        return struct.unpack(">Q", vicon_pose_lcmt._get_packed_fingerprint())[0]
