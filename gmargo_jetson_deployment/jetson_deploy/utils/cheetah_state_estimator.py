...
class StateEstimator:
    ...
    def get_command(self):
        ...
        cmd_height = 0. #0.3 * self.right_stick[1]
        #cmd_height = 0.3 * self.left_stick[0]
        cmd_footswing = max(0, self.left_stick[0]) * 0.27 + 0.03
        ...
        return np.array([cmd_x, cmd_y, cmd_yaw, cmd_height, cmd_freq, self.cmd_phase, self.cmd_offset, self.cmd_bound, self.cmd_duration, cmd_footswing, 0, 0, 0, 0, 0])
