...
def load_and_run_policy(label, experiment_name, probe_policy_label=None, max_vel=1.0, max_yaw_vel=1.0, max_vel_probe=1.0):
    ...
    # L1_command_profile = ElegantGaitProfile(dt=control_dt, filename="../command_profiles/jump_sequence_max_vel_3.json")
    # L1_command_profile = ElegantGaitProfile(dt=control_dt, filename="../command_profiles/jump_sequence_max_vel_3_f2.json")
    # L1_command_profile = ElegantGaitProfile(dt=control_dt, filename="../command_profiles/jump_sequence_max_vel_25_f2.json")
    L1_command_profile = ElegantGaitProfile(dt=control_dt, filename="../command_profiles/dance_in_walked_bud.json")
    L2_command_profile = ElegantGaitProfile(dt=control_dt, filename="../command_profiles/jump_sequence_max_vel_3_f2.json")
    # L1_command_profile = ElegantGaitProfile(dt=control_dt, filename="../command_profiles/stationary_gait_cycle.json")
    # L1_command_profile = ElegantGaitProfile(dt=control_dt, filename="../command_profiles/stationary_trot.json")
    # L1_command_profile = ElegantGaitProfile(dt=control_dt, filename="../command_profiles/frequency_sweep_trot.json")
    # L1_command_profile = ElegantGaitProfile(dt=control_dt, filename="../command_profiles/spin_test_trot.json")
    command_profile.add_triggered_command(button_idx=1, command_profile=L1_command_profile)
    command_profile.add_triggered_command(button_idx=0, command_profile=L2_command_profile)
...
if __name__ == '__main__':
    ...
    label = "20220604_allgaits_binary_jumper_gaitwise_r2_200"
    label = "20220604_allgaits_binary_jumper_gaitwise_r3_200"
    label = "20220606_nonslip_300"
    label = "20220606_lowfriction_300"
    label = "20220606_nonslip_v2_300"
    label = "20220606_nonslip_200"
    label = "20220607_nonslip_durations_300" # best policy so far
    # label = "20220608_100HZTEST_200"
    ...
    label = "20220707_control_footswing_impp_100"
    ...
    probe_policy_label = "20220531_platformer_diverse_tt_100"
    probe_policy_label = "20220601_jumper_300"
    probe_policy_label = "20220604_allgaits_binary_jumper_100"
    probe_policy_label = "20220606_nonslip_v3_300"
    probe_policy_label = "20220606_nonslip_200"
    probe_policy_label = "20220607_nonslip_durations_300"
    # probe_policy_label = "20220608_100HZTEST_200"
    # probe_policy_label = "20220608_100from200HZTEST_200"
    # probe_policy_label = "20220609_continuous_collision_penalty_100"
    # probe_policy_label = "20220609_continuous_collision_penalty_200"
    probe_policy_label = "20220609_continuous_collision_penalty_r2_200"
    # probe_policy_label = "20220609_discrete_lipschitz_07_200"
    # probe_policy_label = "20220610_continuous_lipschitz_07_200"

    experiment_name = "20220611_afternoon"
    experiment_name = "20220613_evenings"
    experiment_name = "20220614_afternoon"

    # load_and_run_policy(label, experiment_name=label, max_vel=1.0, disentangle=True)
    # load_and_run_policy(label, experiment_name=experiment_name, probe_policy_label=probe_policy_label, max_vel=4.0, max_yaw_vel=5.0, max_vel_probe=3.0)
    load_and_run_policy(label, experiment_name=experiment_name, probe_policy_label=probe_policy_label, max_vel=2.0, max_yaw_vel=2.0, max_vel_probe=3.0)
