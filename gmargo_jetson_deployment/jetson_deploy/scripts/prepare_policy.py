...
def bundle_for_deployment(experiment_name, label, jumper=False):
    ...
    # LeggedRobotCfg.env.num_observations = 67

    # LeggedRobotCfg.env.num_observation_history = 15
    # LeggedRobotCfg.control.decimation = 2
...
if __name__ == '__main__':
    ...
    experiment_name = "locomotion/locomotion/2022/05-29/eccv_2022/go1_concurrent_se/sweeps/cse_sweep_gait_reward_jistyleclip_penalty_sweep_highspeed_friction_estimation_low_frequency_and_bound_and_duration/19.13.43/as2_-0.15/stance_1.0/100"
    experiment_name = "locomotion/locomotion/2022/05-31/eccv_2022/go1_concurrent_se/sweeps/platformer_diverse_fix_phase_offset_terrain_type/12.59.15/srn_0.05/stance_1.0/100"
    experiment_name = "locomotion/locomotion/2022/06-01/eccv_2022/go1_concurrent_se/sweeps/flat_ground_observe_contacts/23.46.04/200"
    experiment_name = "locomotion/locomotion/2022/06-01/eccv_2022/go1_concurrent_se/sweeps/flat_ground_transition_frequency/23.47.55/gi_2/100"
    experiment_name = "locomotion/locomotion/2022/06-02/eccv_2022/go1_concurrent_se/sweeps/flat_ground_jumper/09.04.30/gi_10/300"
    experiment_name = "/locomotion/locomotion/2022/06-03/eccv_2022/go1_concurrent_se/sweeps/flat_ground_pacer_nocurric_fix_hop_binary_phases_bound_relax_constraints/16.25.18/gi_10/300"
    experiment_name = "/locomotion/locomotion/2022/06-03/eccv_2022/go1_concurrent_se/sweeps/flat_ground_pronking_amplitude_v3/small_range/gi_10/100"
    experiment_name = "/locomotion/locomotion/2022/06-04/eccv_2022/go1_concurrent_se/sweeps/allgaits_relax_constraints_jumper/00.40.05/gi_10/100"
    experiment_name = "/locomotion/locomotion/2022/06-05/eccv_2022/go1_concurrent_se/sweeps/allgaits_relax_constraints_jumper_gaitwisecurriculum/11.24.23/gi_10/200"
    experiment_name = "/locomotion/locomotion/2022/06-06/eccv_2022/go1_concurrent_se/sweeps/allgaits_relax_constraints_jumper_gaitwisecurriculum_fix_hop_nonslip/08.57.16/gi_10/300"
    # experiment_name = "/locomotion/locomotion/2022/06-06/eccv_2022/go1_concurrent_se/sweeps/allgaits_relax_constraints_jumper_gaitwisecurriculum_fix_hop_friction/08.55.41/gi_10/100"
    experiment_name = "/locomotion/locomotion/2022/06-06/eccv_2022/go1_concurrent_se/sweeps/allgaits_relax_constraints_jumper_gaitwisecurriculum_fix_hop_nonslip/08.57.16/gi_10/200"
    experiment_name = "/locomotion/locomotion/2022/06-07/eccv_2022/go1_concurrent_se/sweeps/allgaits_relax_constraints_jumper_gaitwisecurriculum_fix_hop_nonslip_durations/18.58.05/gi_10/300"
    experiment_name = "/locomotion/locomotion/2022/06-08/eccv_2022/go1_concurrent_se/sweeps/allgaits_relax_constraints_jumper_gaitwisecurriculum_fix_hop_nonslip_durations_100Hz_compensate_penalty_v2/17.07.21/gi_10/200"
    experiment_name = "/locomotion/locomotion/2022/06-09/eccv_2022/go1_concurrent_se/sweeps/gaitwise_base_continuous_collision_penalty/12.14.04/gi_10/100"
    experiment_name = "/locomotion/locomotion/2022/06-09/eccv_2022/go1_concurrent_se/sweeps/gaitwise_base_continuous_collision_penalty/12.14.04/gi_10/200"
    experiment_name = "/locomotion/locomotion/2022/06-09/eccv_2022/go1_concurrent_se/sweeps/gaitwise_base_continuous_collision_penalty/12.14.04/gi_10/200"
    experiment_name = "/locomotion/locomotion/2022/06-09/eccv_2022/go1_concurrent_se/sweeps/gaitwise_base_discrete_lipschitz_phase/12.16.18/lipschitz_0.7/200"
    experiment_name = "/locomotion/locomotion/2022/06-10/eccv_2022/go1_concurrent_se/sweeps/gaitwise_base_continuous_collision_penalty_lipschitz_discrete/08.40.51/gi_10/200"
    experiment_name = "/locomotion/locomotion/2022/06-12/eccv_2022/go1_concurrent_se/sweeps/gaitwise_base_continuous_collision_penalty_platformer_discrete/16.47.32/gi_10/200"
    experiment_name = "/locomotion/locomotion/2022/06-12/eccv_2022/go1_concurrent_se/sweeps/gaitwise_base_continuous_collision_penalty_platformer_discrete_halfheight_no_lipschitz/17.32.30/gi_10/200"
    experiment_name = "/locomotion/locomotion/2022/06-12/eccv_2022/go1_concurrent_se/sweeps/gaitwise_base_continuous_collision_penalty_long_history/17.17.18/gi_10/300"
    experiment_name = "/locomotion/locomotion/2022/06-13/eccv_2022/go1_concurrent_se/sweeps/gaitwise_base_continuous_collision_penalty_force_curriculum/v5/gi_10/300"
    experiment_name = "/locomotion/locomotion/2022/06-10/eccv_2022/go1_concurrent_se/sweeps/gaitwise_base_continuous_collision_penalty_ablate_gait_parameters/19.20.26/gi_10/200"
    experiment_name = "/locomotion/locomotion/2022/07-04/eccv_2022/go1_post_corl/sweeps/gaitwise_base_discrete_collision_penalty_swing_height_high/02.52.33/gi_10/200"
    experiment_name = "/locomotion/locomotion/2022/07-04/eccv_2022/go1_post_corl/sweeps/gaitwise_base_discrete_collision_penalty_swing_height_high_extra_gravity/10.49.30/gi_10/100"
    experiment_name = "/locomotion/locomotion/2022/07-04/eccv_2022/go1_post_corl/sweeps/gaitwise_base_discrete_collision_penalty_swing_height_high_extra_extra_gravity/19.05.25/gi_10/200"
    ...
    label = "20220530_durations_actsmooth_100"
    label = "20220531_platformer_diverse_tt_100"
    label = "20220531_observe_contacts_200"
    label = "20220601_transition_frequency_100"
    label = "20220601_jumper_300"
    label = "20220603_allgaits_slow_300"
    label = "20220603_amplitude_test_100"
    label = "20220604_allgaits_binary_jumper_100"
    label = "20220604_allgaits_binary_jumper_gaitwise_200"
    label = "20220604_allgaits_binary_jumper_gaitwise_r3_200"
    label = "20220606_nonslip_v3_300"
    # label = "20220606_lowfriction_300"
    label = "20220606_nonslip_200"
    label = "20220607_nonslip_durations_300"
    label = "20220608_100from200HZTEST_200"
    label = "20220609_continuous_collision_penalty_100"
    label = "20220609_continuous_collision_penalty_200"
    label = "20220609_continuous_collision_penalty_r2_200"
    label = "20220609_discrete_lipschitz_07_200"
    label = "20220610_continuous_lipschitz_07_200"
    label = "20220612_stage_2_platformer_200"
    label = "20220612_stage_2_platformer_half_200"
    label = "20220612_long_history_300"
    label = "20220613_force_curriculum_5_300"
    label = "20220614_gaitfree_baseline_200"
    label = "20220705_control_footswing"
    label = "20220705_control_footswing_xgrav_100"
    label = "20220705_control_footswing_xxgrav_200"
